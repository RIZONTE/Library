...
extern DELPHI_PACKAGE System::UnicodeString __fastcall ShortenString(HDC DC, const System::UnicodeString S, int Width, int EllipsisWidth = 0x0)/* overload */;
extern DELPHI_PACKAGE bool __fastcall ShortenString(HDC TargetCanvasDC, const System::UnicodeString StrIn, const int AllowedWidth_px, const int EllipsisWidth_px, System::UnicodeString &ShortenedString)/* overload */;
...
extern DELPHI_PACKAGE bool __fastcall IsMouseCursorVisible();
extern DELPHI_PACKAGE void __fastcall ScaleImageList(Vcl::Controls::TImageList* const ImgList, int M, int D);
extern DELPHI_PACKAGE bool __fastcall IsHighContrastEnabled();
extern DELPHI_PACKAGE float __fastcall Divide(const float Dimension, const int DivideBy)/* overload */;
extern DELPHI_PACKAGE int __fastcall Divide(const int Dimension, const int DivideBy)/* overload */;
}	/* namespace Utils */
}	/* namespace Virtualtrees */
