...
// (DO NOT EDIT: machine generated header) 'VirtualTrees.BaseTree.pas' rev: 35.00 (Windows)
...
__interface  INTERFACE_UUID("{2BE3EAFA-5ACB-45B4-9D9A-B58BCC496E17}") IVTEditLink  : public System::IInterface 
{
	...
	virtual bool __stdcall PrepareEdit(TBaseVirtualTree* Tree, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column) = 0 ;
...
typedef void __fastcall (__closure *TVTColumnExportEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::TVTExportType aExportType, Virtualtrees::Header::TVirtualTreeColumn* Column);
...
typedef void __fastcall (__closure *TVTCheckChangingEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TCheckState &NewState, bool &Allowed);
...
typedef void __fastcall (__closure *TVTEditCancelEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::TColumnIndex Column);

typedef void __fastcall (__closure *TVTEditChangingEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, bool &Allowed);

typedef void __fastcall (__closure *TVTEditChangeEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column);

typedef void __fastcall (__closure *TVTFreeNodeEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node);

typedef void __fastcall (__closure *TVTFocusChangingEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode OldNode, Virtualtrees::Types::PVirtualNode NewNode, Virtualtrees::Types::TColumnIndex OldColumn, Virtualtrees::Types::TColumnIndex NewColumn, bool &Allowed);

typedef void __fastcall (__closure *TVTFocusChangeEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column);
...
typedef void __fastcall (__closure *TVTGetImageEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TVTImageKind Kind, Virtualtrees::Types::TColumnIndex Column, bool &Ghosted, System::Uitypes::TImageIndex &ImageIndex);

typedef void __fastcall (__closure *TVTGetImageExEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TVTImageKind Kind, Virtualtrees::Types::TColumnIndex Column, bool &Ghosted, System::Uitypes::TImageIndex &ImageIndex, Vcl::Imglist::TCustomImageList* &ImageList);

typedef void __fastcall (__closure *TVTGetImageTextEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TVTImageKind Kind, Virtualtrees::Types::TColumnIndex Column, System::UnicodeString &ImageText);
...
typedef void __fastcall (__closure *TVTPopupEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, const System::Types::TPoint &P, bool &AskParent, Vcl::Menus::TPopupMenu* &PopupMenu);

typedef void __fastcall (__closure *TVTHelpContextEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, int &HelpContext);

typedef void __fastcall (__closure *TVTCreateEditorEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, /* out */ _di_IVTEditLink &EditLink);
...
typedef void __fastcall (__closure *TVTHeaderAddPopupItemEvent)(System::TObject* const Sender, const Virtualtrees::Types::TColumnIndex Column, Virtualtrees::Types::TAddPopupItemType &Cmd);
...
typedef void __fastcall (__closure *TVTHeaderMouseEvent)(Virtualtrees::Header::TVTHeader* Sender, System::Uitypes::TMouseButton Button, System::Classes::TShiftState Shift, int X, int Y);

typedef void __fastcall (__closure *TVTHeaderMouseMoveEvent)(Virtualtrees::Header::TVTHeader* Sender, System::Classes::TShiftState Shift, int X, int Y);
...
typedef void __fastcall (__closure *TVTHeaderNotifyEvent)(Virtualtrees::Header::TVTHeader* Sender, Virtualtrees::Types::TColumnIndex Column);

typedef void __fastcall (__closure *TVTHeaderDraggingEvent)(Virtualtrees::Header::TVTHeader* Sender, Virtualtrees::Types::TColumnIndex Column, bool &Allowed);

typedef void __fastcall (__closure *TVTHeaderDraggedEvent)(Virtualtrees::Header::TVTHeader* Sender, Virtualtrees::Types::TColumnIndex Column, int OldPosition);

typedef void __fastcall (__closure *TVTHeaderDraggedOutEvent)(Virtualtrees::Header::TVTHeader* Sender, Virtualtrees::Types::TColumnIndex Column, const System::Types::TPoint &DropPosition);

typedef void __fastcall (__closure *TVTHeaderPaintEvent)(Virtualtrees::Header::TVTHeader* Sender, Vcl::Graphics::TCanvas* HeaderCanvas, Virtualtrees::Header::TVirtualTreeColumn* Column, const System::Types::TRect &R, bool Hover, bool Pressed, Virtualtrees::Types::TVTDropMarkMode DropMark);
...
typedef void __fastcall (__closure *TVTBeforeAutoFitColumnEvent)(Virtualtrees::Header::TVTHeader* Sender, Virtualtrees::Types::TColumnIndex Column, Virtualtrees::Types::TSmartAutoFitType &SmartAutoFitType, bool &Allowed);

typedef void __fastcall (__closure *TVTAfterAutoFitColumnEvent)(Virtualtrees::Header::TVTHeader* Sender, Virtualtrees::Types::TColumnIndex Column);

typedef void __fastcall (__closure *TVTAfterAutoFitColumnsEvent)(Virtualtrees::Header::TVTHeader* Sender);

typedef void __fastcall (__closure *TVTColumnCheckChangingEvent)(Virtualtrees::Header::TVTHeader* Sender, Virtualtrees::Types::TColumnIndex Column, Virtualtrees::Types::TCheckState &NewState, bool &Allowed);

typedef void __fastcall (__closure *TVTColumnClickEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::TColumnIndex Column, System::Classes::TShiftState Shift);

typedef void __fastcall (__closure *TVTColumnDblClickEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::TColumnIndex Column, System::Classes::TShiftState Shift);

typedef void __fastcall (__closure *TColumnChangeEvent)(TBaseVirtualTree* const Sender, const Virtualtrees::Types::TColumnIndex Column, bool Visible);

typedef void __fastcall (__closure *TVTColumnWidthDblClickResizeEvent)(Virtualtrees::Header::TVTHeader* Sender, Virtualtrees::Types::TColumnIndex Column, System::Classes::TShiftState Shift, const System::Types::TPoint &P, bool &Allowed);

typedef void __fastcall (__closure *TVTBeforeColumnWidthTrackingEvent)(Virtualtrees::Header::TVTHeader* Sender, Virtualtrees::Types::TColumnIndex Column, System::Classes::TShiftState Shift);

typedef void __fastcall (__closure *TVTAfterColumnWidthTrackingEvent)(Virtualtrees::Header::TVTHeader* Sender, Virtualtrees::Types::TColumnIndex Column);

typedef void __fastcall (__closure *TVTColumnWidthTrackingEvent)(Virtualtrees::Header::TVTHeader* Sender, Virtualtrees::Types::TColumnIndex Column, System::Classes::TShiftState Shift, System::Types::TPoint &TrackPoint, const System::Types::TPoint &P, bool &Allowed);

typedef void __fastcall (__closure *TVTGetHeaderCursorEvent)(Virtualtrees::Header::TVTHeader* Sender, HICON &Cursor);

typedef void __fastcall (__closure *TVTBeforeGetMaxColumnWidthEvent)(Virtualtrees::Header::TVTHeader* Sender, Virtualtrees::Types::TColumnIndex Column, bool &UseSmartColumnWidth);

typedef void __fastcall (__closure *TVTAfterGetMaxColumnWidthEvent)(Virtualtrees::Header::TVTHeader* Sender, Virtualtrees::Types::TColumnIndex Column, int &MaxWidth);

typedef void __fastcall (__closure *TVTCanSplitterResizeColumnEvent)(Virtualtrees::Header::TVTHeader* Sender, const System::Types::TPoint &P, Virtualtrees::Types::TColumnIndex Column, bool &Allowed);
...
typedef void __fastcall (__closure *TVTNodeHeightTrackingEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, System::Classes::TShiftState Shift, System::Types::TPoint &TrackPoint, const System::Types::TPoint &P, bool &Allowed);

typedef void __fastcall (__closure *TVTNodeHeightDblClickResizeEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, System::Classes::TShiftState Shift, const System::Types::TPoint &P, bool &Allowed);

typedef void __fastcall (__closure *TVTCanSplitterResizeNodeEvent)(TBaseVirtualTree* Sender, const System::Types::TPoint &P, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, bool &Allowed);

typedef void __fastcall (__closure *TVTGetUserClipboardFormatsEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::TFormatEtcArray &Formats);
...
typedef void __fastcall (__closure *TVTDragAllowedEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, bool &Allowed);
...
typedef void __fastcall (__closure *TVTDragDropEvent)(TBaseVirtualTree* Sender, System::TObject* Source, _di_IDataObject DataObject, Virtualtrees::Types::TFormatArray Formats, System::Classes::TShiftState Shift, const System::Types::TPoint &Pt, int &Effect, Virtualtrees::Types::TDropMode Mode);

typedef void __fastcall (__closure *TVTBeforeItemEraseEvent)(TBaseVirtualTree* Sender, Vcl::Graphics::TCanvas* TargetCanvas, Virtualtrees::Types::PVirtualNode Node, const System::Types::TRect &ItemRect, System::Uitypes::TColor &ItemColor, Virtualtrees::Types::TItemEraseAction &EraseAction);

typedef void __fastcall (__closure *TVTAfterItemEraseEvent)(TBaseVirtualTree* Sender, Vcl::Graphics::TCanvas* TargetCanvas, Virtualtrees::Types::PVirtualNode Node, const System::Types::TRect &ItemRect);

typedef void __fastcall (__closure *TVTBeforeItemPaintEvent)(TBaseVirtualTree* Sender, Vcl::Graphics::TCanvas* TargetCanvas, Virtualtrees::Types::PVirtualNode Node, const System::Types::TRect &ItemRect, bool &CustomDraw);

typedef void __fastcall (__closure *TVTAfterItemPaintEvent)(TBaseVirtualTree* Sender, Vcl::Graphics::TCanvas* TargetCanvas, Virtualtrees::Types::PVirtualNode Node, const System::Types::TRect &ItemRect);

typedef void __fastcall (__closure *TVTBeforeCellPaintEvent)(TBaseVirtualTree* Sender, Vcl::Graphics::TCanvas* TargetCanvas, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, Virtualtrees::Types::TVTCellPaintMode CellPaintMode, const System::Types::TRect &CellRect, System::Types::TRect &ContentRect);

typedef void __fastcall (__closure *TVTAfterCellPaintEvent)(TBaseVirtualTree* Sender, Vcl::Graphics::TCanvas* TargetCanvas, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, const System::Types::TRect &CellRect);
...
typedef void __fastcall (__closure *TVTMeasureItemEvent)(TBaseVirtualTree* Sender, Vcl::Graphics::TCanvas* TargetCanvas, Virtualtrees::Types::PVirtualNode Node, int &NodeHeight);

typedef void __fastcall (__closure *TVTPaintText)(TBaseVirtualTree* Sender, Vcl::Graphics::TCanvas* const TargetCanvas, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, Virtualtrees::Types::TVSTTextType TextType);
...
typedef void __fastcall (__closure *TVTCompareEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node1, Virtualtrees::Types::PVirtualNode Node2, Virtualtrees::Types::TColumnIndex Column, int &Result);
...
typedef void __fastcall (__closure *TVTHintKindEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, TVTHintKind &Kind);

typedef void __fastcall (__closure *TVTDrawHintEvent)(TBaseVirtualTree* Sender, Vcl::Graphics::TCanvas* HintCanvas, Virtualtrees::Types::PVirtualNode Node, const System::Types::TRect &R, Virtualtrees::Types::TColumnIndex Column);

typedef void __fastcall (__closure *TVTGetHintSizeEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, System::Types::TRect &R);

typedef void __fastcall (__closure *TVTBeforeDrawLineImageEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node, int Level, int &PosX);
...
typedef void __fastcall (__closure *TVTGetCellIsEmptyEvent)(TBaseVirtualTree* Sender, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, bool &IsEmpty);

typedef void __fastcall (__closure *TVTScrollBarShowEvent)(TBaseVirtualTree* Sender, int Bar, bool Show);

typedef Virtualtrees::Types::PVirtualNode __fastcall (__closure *TGetFirstNodeProc)();
...
{
private:
	Virtualtrees::Types::TVirtualNode *FNode;
	bool FCanMoveNext;
...
private:
	...
	Virtualtrees::Types::TVirtualNode *FNode;
	unsigned FNodeLevel;
	Virtualtrees::Types::TCheckState FState;
...
private:
	...
	Virtualtrees::Types::TVirtualNode *FRoot;
	int FDefaultNodeHeight;
	int FIndent;
	Virtualtrees::Types::TCustomVirtualTreeOptions* FOptions;
	unsigned FUpdateCount;
	unsigned FSynchUpdateCount;
	int FNodeDataSize;
	Virtualtrees::Types::TVirtualTreeStates FStates;
	Virtualtrees::Types::TVirtualNode *FLastSelected;
	Virtualtrees::Types::TVirtualNode *FFocusedNode;
	Virtualtrees::Types::TColumnIndex FEditColumn;
	Virtualtrees::Types::TColumnIndex FFocusedColumn;
	System::Types::TPoint FHeightTrackPoint;
	Virtualtrees::Types::TVirtualNode *FHeightTrackNode;
	Virtualtrees::Types::TColumnIndex FHeightTrackColumn;
	Virtualtrees::Types::TScrollDirections FScrollDirections;
	Virtualtrees::Types::TChangeReason FLastStructureChangeReason;
	Virtualtrees::Types::TVirtualNode *FLastStructureChangeNode;
	Virtualtrees::Types::TVirtualNode *FLastChangedNode;
	Virtualtrees::Types::TVirtualNode *FCurrentHotNode;
	Virtualtrees::Types::TColumnIndex FCurrentHotColumn;
	...
	Virtualtrees::Types::TVirtualNode *FRangeAnchor;
	...
	Virtualtrees::Colors::TVTColors* FColors;
	...
	Virtualtrees::Types::TVirtualNode *FDropTargetNode;
	...
	Virtualtrees::Types::TVirtualNode *FLastVCLDragTarget;
	int FVCLDragEffect;
	Virtualtrees::Types::TScrollBarOptions* FScrollBarOptions;
	Virtualtrees::Types::TAutoScrollInterval FAutoScrollInterval;
	...
	Virtualtrees::Types::TVirtualNode *FLastSearchNode;
	...
	bool FChangingTheme;
	Virtualtrees::Types::TVirtualNode *FNextNodeToSelect;
	...
	void __fastcall CalculateVerticalAlignments(Virtualtrees::Types::TVTPaintInfo &PaintInfo, int &VButtonAlign);
	bool __fastcall ChangeCheckState(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TCheckState Value);
	...
	void __fastcall DrawLineImage(const Virtualtrees::Types::TVTPaintInfo &PaintInfo, int X, int Y, int H, int VAlign, Virtualtrees::Types::TVTLineType Style, bool Reverse);
	Virtualtrees::Types::PVirtualNode __fastcall FindInPositionCache(Virtualtrees::Types::PVirtualNode Node, int &CurrentPos)/* overload */;
	Virtualtrees::Types::PVirtualNode __fastcall FindInPositionCache(int Position, int &CurrentPos)/* overload */;
	...
	Virtualtrees::Types::TCheckState __fastcall GetCheckState(Virtualtrees::Types::PVirtualNode Node);
	Virtualtrees::Types::TCheckType __fastcall GetCheckType(Virtualtrees::Types::PVirtualNode Node);
	...
	int __fastcall GetNodeHeight(Virtualtrees::Types::PVirtualNode Node);
	...
	void __fastcall HandleCheckboxClick(Virtualtrees::Types::PVirtualNode pHitNode, int pKeys);
	...
	void __fastcall SetBottomSpace(const int Value);
	...
	void __fastcall SetCheckState(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TCheckState Value);
	void __fastcall SetCheckType(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TCheckType Value);
	void __fastcall SetClipboardFormats(TClipboardFormats* const Value);
	void __fastcall SetColors(Virtualtrees::Colors::TVTColors* const Value);
	void __fastcall SetCustomCheckImages(Vcl::Imglist::TCustomImageList* const Value);
	void __fastcall SetDefaultNodeHeight(int Value);
	...
	void __fastcall SetFocusedColumn(Virtualtrees::Types::TColumnIndex Value);
	...
	void __fastcall SetNodeHeight(Virtualtrees::Types::PVirtualNode Node, int Value);
	...
	void __fastcall SetOptions(Virtualtrees::Types::TCustomVirtualTreeOptions* const Value);
	void __fastcall SetRootNodeCount(unsigned Value);
	void __fastcall SetScrollBarOptions(Virtualtrees::Types::TScrollBarOptions* Value);
	...
	void __fastcall PrepareBackGroundPicture(Vcl::Graphics::TPicture* Source, Vcl::Graphics::TBitmap* DrawingBitmap, int DrawingBitmapWidth, int DrawingBitmapHeight, System::Uitypes::TColor ABkgcolor);
...
protected:
	...
	void __fastcall AdjustTotalHeight(Virtualtrees::Types::PVirtualNode Node, int Value, bool relative = false);
	...
	bool __fastcall CanSplitterResizeNode(const System::Types::TPoint &P, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column);
	...
	virtual bool __fastcall CheckParentCheckState(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TCheckState NewCheckState);
	...
	virtual void __fastcall DetermineHitPositionLTR(Virtualtrees::Types::THitInfo &HitInfo, int Offset, int Right, System::Classes::TAlignment Alignment);
	virtual void __fastcall DetermineHitPositionRTL(Virtualtrees::Types::THitInfo &HitInfo, int Offset, int Right, System::Classes::TAlignment Alignment);
	...
	virtual Virtualtrees::Types::TCheckState __fastcall DetermineNextCheckState(Virtualtrees::Types::TCheckType CheckType, Virtualtrees::Types::TCheckState CheckState);
	virtual Virtualtrees::Types::TScrollDirections __fastcall DetermineScrollDirections(int X, int Y);
	...
	virtual void __fastcall DoAfterCellPaint(Vcl::Graphics::TCanvas* Canvas, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, const System::Types::TRect &CellRect);
	virtual void __fastcall DoAfterItemErase(Vcl::Graphics::TCanvas* Canvas, Virtualtrees::Types::PVirtualNode Node, const System::Types::TRect &ItemRect);
	virtual void __fastcall DoAfterItemPaint(Vcl::Graphics::TCanvas* Canvas, Virtualtrees::Types::PVirtualNode Node, const System::Types::TRect &ItemRect);
	virtual void __fastcall DoAfterPaint(Vcl::Graphics::TCanvas* Canvas);
	virtual void __fastcall DoAutoScroll(int X, int Y);
	virtual bool __fastcall DoBeforeDrag(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column);
	virtual void __fastcall DoBeforeCellPaint(Vcl::Graphics::TCanvas* Canvas, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, Virtualtrees::Types::TVTCellPaintMode CellPaintMode, const System::Types::TRect &CellRect, System::Types::TRect &ContentRect);
	virtual void __fastcall DoBeforeItemErase(Vcl::Graphics::TCanvas* Canvas, Virtualtrees::Types::PVirtualNode Node, const System::Types::TRect &ItemRect, System::Uitypes::TColor &Color, Virtualtrees::Types::TItemEraseAction &EraseAction);
	virtual bool __fastcall DoBeforeItemPaint(Vcl::Graphics::TCanvas* Canvas, Virtualtrees::Types::PVirtualNode Node, const System::Types::TRect &ItemRect);
	virtual void __fastcall DoBeforePaint(Vcl::Graphics::TCanvas* Canvas);
	virtual bool __fastcall DoCancelEdit();
	virtual void __fastcall DoCanEdit(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, bool &Allowed);
	virtual void __fastcall DoCanSplitterResizeNode(const System::Types::TPoint &P, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, bool &Allowed);
	virtual void __fastcall DoChange(Virtualtrees::Types::PVirtualNode Node);
	virtual void __fastcall DoCheckClick(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TCheckState NewCheckState);
	virtual void __fastcall DoChecked(Virtualtrees::Types::PVirtualNode Node);
	virtual bool __fastcall DoChecking(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TCheckState &NewCheckState);
	...
	virtual void __fastcall DoColumnChecked(Virtualtrees::Types::TColumnIndex Column);
	virtual bool __fastcall DoColumnChecking(Virtualtrees::Types::TColumnIndex Column, Virtualtrees::Types::TCheckState &NewCheckState);
	virtual void __fastcall DoColumnClick(Virtualtrees::Types::TColumnIndex Column, System::Classes::TShiftState Shift);
	virtual void __fastcall DoColumnDblClick(Virtualtrees::Types::TColumnIndex Column, System::Classes::TShiftState Shift);
	virtual void __fastcall DoColumnResize(Virtualtrees::Types::TColumnIndex Column);
	virtual void __fastcall DoColumnVisibilityChanged(const Virtualtrees::Types::TColumnIndex Column, bool Visible);
	virtual int __fastcall DoCompare(Virtualtrees::Types::PVirtualNode Node1, Virtualtrees::Types::PVirtualNode Node2, Virtualtrees::Types::TColumnIndex Column);
	virtual _di_IDataObject __fastcall DoCreateDataObject();
	virtual _di_IVTDragManager __fastcall DoCreateDragManager();
	virtual _di_IVTEditLink __fastcall DoCreateEditor(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column);
	virtual void __fastcall DoDragging(const System::Types::TPoint &P);
	virtual void __fastcall DoDragExpand();
	virtual void __fastcall DoBeforeDrawLineImage(Virtualtrees::Types::PVirtualNode Node, int Level, int &XPos);
	...
	virtual void __fastcall DoDragDrop(System::TObject* Source, const _di_IDataObject DataObject, const Virtualtrees::Types::TFormatArray Formats, System::Classes::TShiftState Shift, const System::Types::TPoint &Pt, int &Effect, Virtualtrees::Types::TDropMode Mode);
	void __fastcall DoDrawHint(Vcl::Graphics::TCanvas* Canvas, Virtualtrees::Types::PVirtualNode Node, const System::Types::TRect &R, Virtualtrees::Types::TColumnIndex Column);
	...
	virtual void __fastcall DoFocusChange(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column);
	virtual bool __fastcall DoFocusChanging(Virtualtrees::Types::PVirtualNode OldNode, Virtualtrees::Types::PVirtualNode NewNode, Virtualtrees::Types::TColumnIndex OldColumn, Virtualtrees::Types::TColumnIndex NewColumn);
	...
	virtual System::Types::TPoint __fastcall DoGetCellContentMargin(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, Virtualtrees::Types::TVTCellContentMarginType CellContentMarginType = (Virtualtrees::Types::TVTCellContentMarginType)(0x0), Vcl::Graphics::TCanvas* Canvas = (Vcl::Graphics::TCanvas*)(0x0));
	virtual void __fastcall DoGetCursor(System::Uitypes::TCursor &Cursor);
	virtual void __fastcall DoGetHeaderCursor(HICON &Cursor);
	virtual void __fastcall DoGetHintSize(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, System::Types::TRect &R);
	void __fastcall DoGetHintKind(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, TVTHintKind &Kind);
	virtual Vcl::Imglist::TCustomImageList* __fastcall DoGetImageIndex(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TVTImageKind Kind, Virtualtrees::Types::TColumnIndex Column, bool &Ghosted, System::Uitypes::TImageIndex &Index);
	virtual void __fastcall DoGetImageText(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TVTImageKind Kind, Virtualtrees::Types::TColumnIndex Column, System::UnicodeString &ImageText);
	...
	virtual Vcl::Menus::TPopupMenu* __fastcall DoGetPopupMenu(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, const System::Types::TPoint &Position);
	virtual void __fastcall DoGetUserClipboardFormats(Virtualtrees::Types::TFormatEtcArray &Formats);
	void __fastcall DoHeaderAddPopupItem(const Virtualtrees::Types::TColumnIndex Column, Virtualtrees::Types::TAddPopupItemType &Cmd);
	...
	virtual void __fastcall DoHeaderDragged(Virtualtrees::Types::TColumnIndex Column, Virtualtrees::Types::TColumnPosition OldPosition);
	virtual void __fastcall DoHeaderDraggedOut(Virtualtrees::Types::TColumnIndex Column, const System::Types::TPoint &DropPosition);
	virtual bool __fastcall DoHeaderDragging(Virtualtrees::Types::TColumnIndex Column);
	virtual void __fastcall DoHeaderDraw(Vcl::Graphics::TCanvas* Canvas, Virtualtrees::Header::TVirtualTreeColumn* Column, const System::Types::TRect &R, bool Hover, bool Pressed, Virtualtrees::Types::TVTDropMarkMode DropMark);
	...
	virtual void __fastcall DoMeasureItem(Vcl::Graphics::TCanvas* TargetCanvas, Virtualtrees::Types::PVirtualNode Node, int &NodeHeight);
	...
	virtual bool __fastcall DoNodeHeightDblClickResize(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, System::Classes::TShiftState Shift, const System::Types::TPoint &P);
	virtual bool __fastcall DoNodeHeightTracking(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, System::Classes::TShiftState Shift, System::Types::TPoint &TrackPoint, const System::Types::TPoint &P);
	...
	virtual void __fastcall DoPaintDropMark(Vcl::Graphics::TCanvas* Canvas, Virtualtrees::Types::PVirtualNode Node, const System::Types::TRect &R);
	virtual void __fastcall DoPaintNode(Virtualtrees::Types::TVTPaintInfo &PaintInfo);
	virtual void __fastcall DoPaintText(Virtualtrees::Types::PVirtualNode Node, Vcl::Graphics::TCanvas* const Canvas, Virtualtrees::Types::TColumnIndex Column, Virtualtrees::Types::TVSTTextType TextType);
	virtual void __fastcall DoPopupMenu(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, const System::Types::TPoint &Position);
	...
	virtual void __fastcall DrawDottedHLine(const Virtualtrees::Types::TVTPaintInfo &PaintInfo, int Left, int Right, int Top);
	virtual void __fastcall DrawDottedVLine(const Virtualtrees::Types::TVTPaintInfo &PaintInfo, int Top, int Bottom, int Left);
	virtual void __fastcall DrawGridHLine(const Virtualtrees::Types::TVTPaintInfo &PaintInfo, int Left, int Right, int Top);
	virtual void __fastcall DrawGridVLine(const Virtualtrees::Types::TVTPaintInfo &PaintInfo, int Top, int Bottom, int Left, bool pFixedColumn = false);
	...
	virtual int __fastcall GetCheckImage(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TCheckType ImgCheckType = (Virtualtrees::Types::TCheckType)(0x0), Virtualtrees::Types::TCheckState ImgCheckState = (Virtualtrees::Types::TCheckState)(0x0), bool ImgEnabled = true);
	virtual Virtualtrees::Header::TVirtualTreeColumnClass __fastcall GetColumnClass();
	...
	virtual System::Types::TSize __fastcall GetImageSize(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TVTImageKind Kind = (Virtualtrees::Types::TVTImageKind)(0x0), Virtualtrees::Types::TColumnIndex Column = (Virtualtrees::Types::TColumnIndex)(0x0), bool IncludePadding = true);
	...
	virtual int __fastcall GetMaxRightExtend();
	virtual void __fastcall GetNativeClipboardFormats(Virtualtrees::Types::TFormatEtcArray &Formats);
	...
	virtual bool __fastcall HasImage _DEPRECATED_ATTRIBUTE1("Use GetImageSize instead") (Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TVTImageKind Kind, Virtualtrees::Types::TColumnIndex Column);
	virtual bool __fastcall HasPopupMenu(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, const System::Types::TPoint &Pos);
	...
	void __fastcall InternalSetFocusedColumn(const Virtualtrees::Types::TColumnIndex index);
	...
	virtual void __fastcall PaintCheckImage(Vcl::Graphics::TCanvas* Canvas, const Virtualtrees::Types::TVTImageInfo &ImageInfo, bool Selected);
	...
	virtual void __fastcall PaintNodeButton(Vcl::Graphics::TCanvas* Canvas, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, const System::Types::TRect &R, int ButtonX, int ButtonY, System::Classes::TBiDiMode BidiMode);
	virtual void __fastcall PaintTreeLines(const Virtualtrees::Types::TVTPaintInfo &PaintInfo, int IndentSize, const Virtualtrees::Types::TLineImage LineImage);
	...
	virtual void __fastcall PrepareCell(Virtualtrees::Types::TVTPaintInfo &PaintInfo, int WindowOrgX, int MaxWidth);
	...
	virtual void __fastcall SetFocusedNodeAndColumn(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column);
	void __fastcall SetRangeX(int value);
	...
	void __fastcall UpdateColumnCheckState(Virtualtrees::Header::TVirtualTreeColumn* Col);
	...
	__property Virtualtrees::Types::TAutoScrollInterval AutoScrollInterval = {read=FAutoScrollInterval, write=FAutoScrollInterval, default=1};
	...
	__property int BackgroundOffsetX = {read=FBackgroundOffsetX, write=SetBackgroundOffset, stored=IsStored_BackgroundOffsetXY, index=0, nodefault};
	__property int BackgroundOffsetY = {read=FBackgroundOffsetY, write=SetBackgroundOffset, stored=IsStored_BackgroundOffsetXY, index=1, nodefault};
	__property Vcl::Forms::TBorderStyle BorderStyle = {read=FBorderStyle, write=SetBorderStyle, default=1};
	__property int BottomSpace = {read=FBottomSpace, write=SetBottomSpace, stored=IsStored_BottomSpace, nodefault};
	...
	__property Virtualtrees::Colors::TVTColors* Colors = {read=FColors, write=SetColors};
	...
	__property int DefaultNodeHeight = {read=FDefaultNodeHeight, write=SetDefaultNodeHeight, stored=IsStored_DefaultNodeHeight, nodefault};
	...
	__property Virtualtrees::Types::TColumnIndex EditColumn = {read=FEditColumn, write=FEditColumn, nodefault};
	...
	__property int Indent = {read=FIndent, write=SetIndent, stored=IsStored_Indent, nodefault};
	...
	__property int Margin = {read=FMargin, write=SetMargin, stored=IsStored_Margin, nodefault};
	...
	__property int RangeX = {read=GetRangeX, nodefault};
	__property int RangeY = {read=FRangeY, nodefault};
	__property unsigned RootNodeCount = {read=GetRootNodeCount, write=SetRootNodeCount, default=0};
	__property Virtualtrees::Types::TScrollBarOptions* ScrollBarOptions = {read=FScrollBarOptions, write=SetScrollBarOptions};
	...
	__property int TextMargin = {read=FTextMargin, write=SetTextMargin, stored=IsStored_TextMargin, nodefault};
	__property Virtualtrees::Types::TCustomVirtualTreeOptions* TreeOptions = {read=FOptions, write=SetOptions};
...
public:
	...
	virtual bool __fastcall CanEdit(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column);
	...
	virtual void __fastcall DrawGridLine(Vcl::Graphics::TCanvas* Canvas, const System::Types::TRect &R);
	virtual bool __fastcall EditNode(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column);
	...
	System::Types::TRect __fastcall GetDisplayRect(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, bool TextOnly, bool Unclipped = false, bool ApplyCellContentMargin = false);
	...
	Virtualtrees::Types::PVirtualNode __fastcall GetFirstChecked(Virtualtrees::Types::TCheckState State = (Virtualtrees::Types::TCheckState)(0x2), bool ConsiderChildrenAbove = false);
	...
	virtual void __fastcall GetHitTestInfoAt(int X, int Y, bool Relative, Virtualtrees::Types::THitInfo &HitInfo, System::Classes::TShiftState ShiftState = System::Classes::TShiftState() );
	...
	virtual int __fastcall GetMaxColumnWidth(Virtualtrees::Types::TColumnIndex Column, bool UseSmartColumnWidth = false);
	Virtualtrees::Types::PVirtualNode __fastcall GetNext(Virtualtrees::Types::PVirtualNode Node, bool ConsiderChildrenAbove = false);
	Virtualtrees::Types::PVirtualNode __fastcall GetNextChecked(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TCheckState State = (Virtualtrees::Types::TCheckState)(0x2), bool ConsiderChildrenAbove = false)/* overload */;
	...
	Virtualtrees::Types::PVirtualNode __fastcall GetNodeAt(int X, int Y)/* overload */;
	Virtualtrees::Types::PVirtualNode __fastcall GetNodeAt(int X, int Y, bool Relative, int &NodeTop)/* overload */;
	...
	int __fastcall GetOffset(Virtualtrees::Types::TVTElement pElement, Virtualtrees::Types::PVirtualNode pNode);
	...
	Virtualtrees::Types::PVirtualNode __fastcall GetPreviousChecked(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TCheckState State = (Virtualtrees::Types::TCheckState)(0x2), bool ConsiderChildrenAbove = false);
	...
	void __fastcall InvalidateColumn(Virtualtrees::Types::TColumnIndex Column);
	...
	virtual void __fastcall MeasureItemHeight(Vcl::Graphics::TCanvas* const Canvas, Virtualtrees::Types::PVirtualNode Node);
	...
	virtual void __fastcall PaintTree(Vcl::Graphics::TCanvas* TargetCanvas, const System::Types::TRect &Window, const System::Types::TPoint &Target, Virtualtrees::Types::TVTInternalPaintOptions PaintOptions, Vcl::Graphics::TPixelFormat PixelFormat = (Vcl::Graphics::TPixelFormat)(0x0));
	...
	bool __fastcall ProcessDrop(const _di_IDataObject DataObject, Virtualtrees::Types::PVirtualNode TargetNode, int &Effect, Virtualtrees::Types::TVTNodeAttachMode Mode);
	bool __fastcall ProcessOLEData(TBaseVirtualTree* Source, const _di_IDataObject DataObject, Virtualtrees::Types::PVirtualNode TargetNode, Virtualtrees::Types::TVTNodeAttachMode Mode, bool Optimized);
	...
	bool __fastcall ScrollIntoView(Virtualtrees::Types::TColumnIndex Column, bool Center, Virtualtrees::Types::PVirtualNode Node = (Virtualtrees::Types::PVirtualNode)(0x0))/* overload */;
	void __fastcall SelectAll(bool VisibleOnly);
	void __fastcall SetCheckStateForAll(Virtualtrees::Types::TCheckState aCheckState, bool pSelectedOnly, bool pExcludeDisabled = true);
	...
	virtual void __fastcall Sort(Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, Virtualtrees::Types::TSortDirection Direction, bool DoInit = true);
	virtual void __fastcall SortTree(Virtualtrees::Types::TColumnIndex Column, Virtualtrees::Types::TSortDirection Direction, bool DoInit = true);
	...
	TVTVirtualNodeEnumeration __fastcall CheckedNodes(Virtualtrees::Types::TCheckState State = (Virtualtrees::Types::TCheckState)(0x2), bool ConsiderChildrenAbove = false);
	...
	__property Virtualtrees::Types::TCheckState CheckState[Virtualtrees::Types::PVirtualNode Node] = {read=GetCheckState, write=SetCheckState};
	__property Virtualtrees::Types::TCheckType CheckType[Virtualtrees::Types::PVirtualNode Node] = {read=GetCheckType, write=SetCheckType};
	...
	__property Virtualtrees::Types::TColumnIndex FocusedColumn = {read=FFocusedColumn, write=SetFocusedColumn, default=-2};
	...
	__property Virtualtrees::Types::TColumnIndex HotColumn = {read=FCurrentHotColumn, nodefault};
	...
	__property int NodeHeight[Virtualtrees::Types::PVirtualNode Node] = {read=GetNodeHeight, write=SetNodeHeight};
...
typedef void __fastcall (__closure *TVTGetCellContentMarginEvent)(TBaseVirtualTree* Sender, Vcl::Graphics::TCanvas* HintCanvas, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, Virtualtrees::Types::TVTCellContentMarginType CellContentMarginType, System::Types::TPoint &CellContentMargin);

typedef void __fastcall (__closure *TVTGetNodeWidthEvent)(TBaseVirtualTree* Sender, Vcl::Graphics::TCanvas* HintCanvas, Virtualtrees::Types::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column, int &NodeWidth);
