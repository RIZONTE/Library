...
// (DO NOT EDIT: machine generated header) 'VirtualTrees.AncestorVCL.pas' rev: 35.00 (Windows)
...
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TVTRenderOLEDataEvent)(Virtualtrees::Basetree::TBaseVirtualTree* Sender, const tagFORMATETC &FormatEtcIn, /* out */ tagSTGMEDIUM &Medium, bool ForClipboard, HRESULT &Result);
...
protected:
	...
	virtual Virtualtrees::Basetree::TBaseVirtualTree* __fastcall GetTreeFromDataObject(const _di_IDataObject DataObject);
